...
to keep the history of rating changes over time. When a movie’s rating changes, 
the current record is “closed” by setting its end_date to the previous day, 
and a new record is inserted with the updated rating and a new start_date.
